#!/usr/bin/env python3
"""
Simple CLI agent that calls an LLM (OpenRouter) and returns a JSON response.
...
def main():
    ...
    model = os.getenv("LLM_MODEL", "ollama/qwen2.5-coder:7b")
    ...
    client = OpenAI(
        base_url=base_url,
        api_key=api_key,
        default_headers={},  # Можно добавить заголовки, если нужно
    )
